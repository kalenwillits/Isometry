...
#   3. Run: godot --headless --path app --export-release "macOS" releases/isometry_macos.zip
...
echo "  godot --headless --path app --export-release \"macOS\" releases/isometry_macos.zip"
exit 1
