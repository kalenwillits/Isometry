...
#   3. Run: godot --headless --path app --export-release "Launcher macOS" releases/isometry_launcher_macos.zip
...
echo "  godot --headless --path app --export-release \"Launcher macOS\" releases/isometry_launcher_macos.zip"
exit 1
